...
public class Test4 extends JFrame
{
	...
	{
		new Test4("GridBagLayout Example");
	}
	...
	public void createGui()
	{
		...
		panel = new JPanel();
		TitledBorder title = BorderFactory.createTitledBorder("Dot-Square");
		panel.setBorder(title);
		GridBagLayout gb = new GridBagLayout();
		GridBagConstraints c = new GridBagConstraints();
		try{
		Font font = Font.createFont(Font.TRUETYPE_FONT,new FileInputStream("KR652.TTF")).deriveFont(Font.BOLD,25);
		panel.setFont(font);
		
		
		panel.setLayout(gb);
		
		button1=new JButton("Hkqous'k");
